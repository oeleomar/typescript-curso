...
/***/ "./src/A0019-webpack/form-control.ts":
/*!*******************************************!*\
  !*** ./src/A0019-webpack/form-control.ts ***!
  \*******************************************/
...
const hideErrorMesseges = (form) => {
    form
        .querySelectorAll('.' + SHOW_ERROR_MESSAGES)
        .forEach((item) => item.classList.remove(SHOW_ERROR_MESSAGES));
};
const showErrorMessege = (input, msg) => {
...
const checkForEmptyFields = (...inputs) => {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessege(input, 'Campo vazio');
    });
};
const checkEmail = (input) => {
    if (!(0, isEmail_1.default)(input.value))
        showErrorMessege(input, 'Email inválido');
};
...
/*!************************************!*\
  !*** ./src/A0019-webpack/index.ts ***!
  \************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/A0019-webpack/form-control.ts");
